...
.. TIP:: 
   *gBridge.io* is an open source application. However, I provide an inexpensive hosted appliance of gBridge. 
...
.. toctree::
   ...
   integration/fhem.rst
   integration/communityManuals.rst